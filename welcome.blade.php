...
<table class="table table-striped table-inverse table-responsive">
    <thead class="thead-inverse">
      ...
      <tbody id="tbl_estudiantes" >  
            ...
            include("datos_conexion.php");
            $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
            $db_conexion ->real_query("select e.id_estudiantes as id,e.carne,e.nombres,e.apellidos,e.direccion,e.telefono,e.correo_electronico,t.sangre,e.fecha_nacimiento,e.id_tipo_sangre FROM estudiantes as e inner join tipos_sangre as t on e.id_tipo_sangre = t.id_tipo_sangre;");
            $resultado = $db_conexion->use_result();
            while($fila = $resultado->fetch_assoc()){
  ...
  <script>
      $("#tbl_estudiantes").on('click','tr td',function (e) {
        var target,id,ids,carne,nombres,apellidos,direccion,telefono,correo_electronico,fecha_nacimiento;
        target = $(event.target);
